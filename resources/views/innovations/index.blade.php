                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3">
                                    <a href="{{ route('innovations.index', ['sort_by1' => 'titulo', 'sort_direction1' => $sortDirection1 === 'asc' ? 'desc' : 'asc', 'sort_by2' => $sortBy2, 'sort_direction2' => $sortDirection2]) }}">
                                        Título
                                        @if($sortBy1 == 'titulo')
                                ...
                                <th scope="col" class="px-6 py-3">
                                    <a href="{{ route('innovations.index', ['sort_by1' => 'innovador', 'sort_direction1' => $sortDirection1 === 'asc' ? 'desc' : 'asc', 'sort_by2' => $sortBy2, 'sort_direction2' => $sortDirection2]) }}">
                                        Autor
