                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3">
                                    <a href="{{ route('videos.index', ['sort_by1' => 'titulo', 'sort_direction1' => $sortDirection1 === 'asc' ? 'desc' : 'asc', 'sort_by2' => $sortBy2, 'sort_direction2' => $sortDirection2]) }}">
                                        Título
                                        @if($sortBy1 == 'titulo')
                                ...
                                <th scope="col" class="px-6 py-3">
                                    <a href="{{ route('videos.index', ['sort_by1' => 'innovador', 'sort_direction1' => $sortDirection1 === 'asc' ? 'desc' : 'asc', 'sort_by2' => $sortBy2, 'sort_direction2' => $sortDirection2]) }}">
                                        Creador
                                        @if($sortBy1 == 'innovador')
                                            @if($sortDirection1 == 'asc')
                                                <i class="fa-solid fa-arrow-up"></i>
                                            @else
                                                <i class="fa-solid fa-arrow-down"></i>
                                ...
                                <th scope="col" class="px-6 py-3">
                                    <a href="{{ route('videos.index', ['sort_by1' => 'rol_autor', 'sort_direction1' => $sortDirection1 === 'asc' ? 'desc' : 'asc', 'sort_by2' => $sortBy2, 'sort_direction2' => $sortDirection2]) }}">
                                        Rol
                                ...
                                <th scope="col" class="px-6 py-3">
                                    <a href="{{ route('videos.index', ['sort_by1' => 'puntaje', 'sort_direction1' => $sortDirection1 === 'asc' ? 'desc' : 'asc', 'sort_by2' => $sortBy2, 'sort_direction2' => $sortDirection2]) }}">
                                        Puntaje
                                        @if($sortBy1 == 'puntaje')
                                            @if($sortDirection1 == 'asc')
                                                <i class="fa-solid fa-arrow-up"></i>
                        ...
                        <tbody>
                            @foreach ($videos as $video)
                                <tr class="even:bg-gray-100 odd:bg-white border-b cursor-pointer hover:bg-gray-200"
                                    ...
                                    <td class="px-6 py-4">
                                        @if($video->evaluado_por_usuario_actual || (auth()->check() && (auth()->user()->rol == 'superadmin')))
